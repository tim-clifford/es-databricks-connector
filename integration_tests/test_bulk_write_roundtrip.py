...
# MAGIC Owns the **write-result** side of the round-trip: that `bulk_write` returns the contract
...
class TestBulkWriteResultContract(NotebookTestFixture):
    ...
    def test_idempotent_rewrite_no_duplicates(self):
        ...
        assert self.count_after_idem == 3, self.count_after_idem

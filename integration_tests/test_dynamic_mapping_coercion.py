...
class TestDynamicMappingCoercion(NotebookTestFixture):
    ...
    def test_direct_aggregation_sees_coerced_integer(self):
        ...
        assert self.num_agg_sum == 20.0, f"expected coerced sum 20.0 (10 + truncated 10), got {self.num_agg_sum}"
    ...
    def test_direct_term_query_cannot_find_the_long_string(self):
        ...
        assert self.str_term_hits == 0, f"expected 0 hits (value exceeded ignore_above, not indexed), got {self.str_term_hits}"
